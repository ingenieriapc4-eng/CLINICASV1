...
La versión online abre con una pantalla pública con **Probar DEMO**, **Iniciar sesión** y **Activar licencia**. La demo usa datos ficticios y es de solo lectura. La activación se realiza después con archivo `.clsv` o código; luego se crea el usuario administrador.
